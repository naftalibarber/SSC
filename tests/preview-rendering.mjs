...
globalThis.SSCPreviewV1.render(colorContainer,"R U R' U'",'333',{strict:true});
...
globalThis.SSCPreviewV1.render(stableContainer,'','333',{strict:true});
...
globalThis.SSCPreviewV1.render(stableContainer,"R U R' U'",'333',{strict:true});
