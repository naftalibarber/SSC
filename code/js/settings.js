(() => {
  ...
  const defaults={textSize:100,font:'Rubik',timerFont:'Orbitron',theme:'light',primaryColor:'#2563eb'};
  ...
  function timerFontStack(font){
    if(font==='Orbitron')return '"Orbitron",sans-serif';
  ...
  function updateLabels(){
    ...
    document.getElementById('fontSettingLabel').textContent=en?'Text font':'גופן הטקסט';
    const timerLabel=document.getElementById('timerFontSettingLabel');
    if(timerLabel)timerLabel.textContent=en?'Timer font':'גופן הטיימר';
