(() => {
  ...
  function ensureAdvancedUi(){
    if(!document.getElementById('sscTrainingStyles')){const link=document.createElement('link');link.id='sscTrainingStyles';link.rel='stylesheet';link.href='./code/css/training-upgrades.css?v=20260831-full-history-1';document.head.appendChild(link);}
