(() => {
  ...
  function updateFullscreenButton(){
    ...
    const focusButton=document.querySelector('[data-focus-fullscreen]');if(focusButton){focusButton.textContent=label;focusButton.title=label;focusButton.setAttribute('aria-label',label);}
  }
  ...
  document.getElementById('focusModeButton').addEventListener('click',()=>setFocusMode(!isFocusMode()));document.getElementById('fullscreenButton').addEventListener('click',toggleFullscreen);document.querySelector('[data-focus-exit]').addEventListener('click',()=>setFocusMode(false));document.querySelector('[data-focus-fullscreen]').addEventListener('click',toggleFullscreen);
