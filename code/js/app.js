(() => {
  ...
  document.addEventListener('keydown',event=>{
    ...
    if(primaryModifier&&!event.altKey){
      ...
      const eventShortcuts={1:'sq1',2:'222',3:'333',4:'444',5:'555',6:'666',7:'777',p:'pyram',m:'minx',s:'skewb',c:'clock',f:'fto'};
